...
const showRecipe = async ()=>{
    try {
        ...
        (0, _resultsViewJsDefault.default).update(_modelJs.getSearchResulspage());
        //loading recipe
        await _modelJs.loadRecipe(id);
        //rendering recipe
        const { recipe } = _modelJs.state; //destructured recipe variable, see the one in model.js for more indepth explanation.
...
const showSearchResults = async ()=>{
    try {
        ...
        //render results
        (0, _resultsViewJsDefault.default).render(_modelJs.getSearchResulspage());
        //render pagination
...
const ShowPaginationResults = (gotoPage)=>{
    (0, _resultsViewJsDefault.default).render(_modelJs.getSearchResulspage(gotoPage));
    //render pagination
    (0, _paginationViewJsDefault.default).render(_modelJs.state.search);
};
...
const init = ()=>{
    ...
    (0, _paginationViewJsDefault.default).addHandlerClick(ShowPaginationResults);
    (0, _recipeViewJsDefault.default).AddHandlerAddBookmark(controlAddBookmarks);
    (0, _addRecipeViewJsDefault.default).addHandlerUpload(controlAddRecipe);
    (0, _bookmarksViewJsDefault.default).AddHandlerRenderBookmarks(renderBookamarks);
};
init();

},{"./model.js":"Y4A21","./views/recipeView.js":"l60JC","./views/searchView.js":"9OQAM","./views/resultsView.js":"cSbZE","./views/bookmarksView.js":"4Lqzq","./views/paginationView.js":"6z7bi","./views/addRecipeView.js":"i6DNj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"Y4A21":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "state", ()=>state);
parcelHelpers.export(exports, "loadRecipe", ()=>loadRecipe);
parcelHelpers.export(exports, "loadSearchResults", ()=>loadSearchResults);
parcelHelpers.export(exports, "getSearchResulspage", ()=>getSearchResulspage);
...
const getSearchResulspage = (page = state.search.page)=>{
...
const Key = "caceb93a-d920-4fc9-a34b-b33976ae42c4";
...
class RecipeView extends (0, _viewJsDefault.default) {
    ...
    _generateMarkup() {
        // 2) Rendering recipe
        const IngredArray = this._data.ingredients.map((ingred)=>{
            ...
            return `
                ...
                <div class="recipe__quantity">${// ingred.quantity          //comment out the function and ternary to view the raw variable
            //OR
            // (() => {
            ...
            ingred.quantity == null ? "" : ingred.quantity}</div>
...
},{"./View.js":"5cUXS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","url:../../img/icons.svg":"loVOp"}]},["hycaY","aenu9"], "aenu9", "parcelRequire5486")
